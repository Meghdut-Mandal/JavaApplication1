...
public class TeacherClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        facultyIDLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        facultyIDLabel.setText("Faculty ID:");

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("DBMS LAB ");

        jLabel2.setText("CS-7");

        jLabel3.setText("Semester - 4");

        jLabel4.setText("Logout");

        jLabel5.setText("Class Timer:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherClient().setVisible(true);
            }
        });
    }
